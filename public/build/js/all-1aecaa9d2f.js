		...
		var appendCaptions = function(){
			...
			slider.children.each(function(index){
				...
				if (title != undefined && ('' + title).length) {
					if($(window).width() < 753){
                    	$(this).append('<div class="bx-caption"><span style="font-size:3vw;">' + title + '</span></div>');
                    } else {
                    	$(this).append('<div class="bx-caption"><span style="font-size:1.5vw;">' + title + '</span></div>');
                    }
                }
			});
		}
